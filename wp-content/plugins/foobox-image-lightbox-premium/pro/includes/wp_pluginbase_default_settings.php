...
if (!class_exists('wp_pluginbase_v2_6_default_settings')) {

  class wp_pluginbase_v2_6_default_settings {
...
<div class="wrap" id="<?php echo $plugin_name; ?>-settings">
	...
	<?php echo $summary; ?>
        ...
        ?>
	<form <?php if (!is_network_admin()) { ?>action="options.php"<?php } ?> method="post">
		<?php settings_fields($plugin_name); ?>
                ...
                <?php
                    ...
                    foreach ($tabs as $tab) {
                        ...
                        self::do_settings_sections_for_tab($plugin_name, $tab['sections']);
                        echo "</div>";
                        if ($first) { $first = false; }
                    }
                ?>

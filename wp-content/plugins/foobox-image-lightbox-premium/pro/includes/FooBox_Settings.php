...
//			) );
			...
			if ( apply_filters( 'foobox_settings_show_advanced', true ) ) {
				...
				$foobox->admin_settings_add( array(
					...
					'desc'    => sprintf( __( 'By default, we defer running the FooBox javascript to work with most optimization plugins. You can choose to turn this off if there are problems.', 'foobox' ), $name ),
					'type'    => 'checkbox',
					'section' => 'other',
					'tab'     => 'advanced'
				) );
